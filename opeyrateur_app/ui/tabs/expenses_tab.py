...
def refresh_expenses_list(app):
    import pandas as pd
    from opeyrateur_app.core.data_manager import load_expenses, MONTHS_FR
...
def _add_proof_to_selected(app):
    ...
    from opeyrateur_app.core.data_manager import delete_expense, save_expense
...
def _export_fec_expenses(app):
    ...
    import pandas as pd
    from opeyrateur_app.core.data_manager import ACCOUNT_MAP
...
def _import_bank_csv(app):
    ...
    from opeyrateur_app.core.data_manager import import_expenses_from_csv
