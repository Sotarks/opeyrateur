...
from opeyrateur_app.core.data_manager import get_invoice_path, delete_invoice, MONTHS_FR, backup_database, save_to_excel, mark_invoices_as_sent
...
class InvoiceActions:
            ...
            if new_creation_date and new_creation_date != old_date:
                ...
                if not current_id_input.startswith(new_date_prefix):
                    ...
                    if old_date_obj.year != new_date_obj.year:
                        ...
                        from opeyrateur_app.core.data_manager import get_next_sequence_id
    ...
    def _prompt_send_email(self, invoice_data=None, pdf_path=None, email_subject=None, invoice_data_list=None):
        ...
        def send():
            ...
            import opeyrateur_app.services.email_manager as email_manager
